...
fn test_filter_by_action_file() {
    let entries = vec![
        ...
        create_test_audit_entry(
            ...
            Actor { type_: ActorType::User, id: "1".to_string(), name: "User".to_string() },
            Resource { type_: "command".to_string(), id: "2".to_string(), path: None },
        ),
    ];
...
fn test_filter_by_actor() {
    let entries = vec![
        create_test_audit_entry(
            AuditAction::FileRead { path: "a.txt".to_string() },
            Actor { type_: ActorType::User, id: "user-1".to_string(), name: "User 1".to_string() },
            Resource { type_: "file".to_string(), id: "1".to_string(), path: None },
        ),
        create_test_audit_entry(
            AuditAction::FileRead { path: "b.txt".to_string() },
            Actor { type_: ActorType::User, id: "user-2".to_string(), name: "User 2".to_string() },
...
fn test_filter_by_time_range() {
    ...
    let filtered = filter_by_time_range(&entries, now - chrono::Duration::hours(1), now + chrono::Duration::hours(1));
...
fn test_filter_by_time_range_outside() {
    ...
    let filtered = filter_by_time_range(&entries, now - chrono::Duration::days(1), now - chrono::Duration::hours(12));
